...
func TestInitLedger(t *testing.T) {
	...
	sampleTransfer := SmartContract{}
	err := sampleTransfer.InitLedger(transactionContext)
...
func TestCreateSample(t *testing.T) {
	...
	err := assetTransfer.CreateSample(transactionContext, "", "", 0)
	require.NoError(t, err)

	chaincodeStub.GetStateReturns([]byte{}, nil)
	err = assetTransfer.CreateSample(transactionContext, "asset1", "", 0)
	require.EqualError(t, err, "the sample asset1 already exists")
