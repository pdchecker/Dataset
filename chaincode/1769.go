...
func (s *SmartContract) Invoke(APIstub shim.ChaincodeStubInterface) sc.Response {
	...
	case "createPaciente":
		return s.createPaciente(APIstub, args)	
	case "changePacienteMedico":
		return s.changePacienteMedico(APIstub, args)	
	default:
...
func (s *SmartContract) initLedger(APIstub shim.ChaincodeStubInterface) sc.Response {
	cars := []Paciente{
		Paciente{Nome: "João", Sala: "20", Medico: "Joana", Especialidade: "Cardiologia", Exame:"Exame ao coração"},
		Paciente{Nome: "Jose", Sala: "40", Medico: "Joana", Especialidade: "Cardiologia", Exame:"Exame ao coração"},
		Paciente{Nome: "Maria", Sala: "35", Medico: "Joana", Especialidade: "Cardiologia", Exame:"Exame ao coração"},
	}
...
func (s *SmartContract) createPaciente(APIstub shim.ChaincodeStubInterface, args []string) sc.Response {

	if len(args) != 6 {
		return shim.Error("Incorrect number of arguments. Expecting 6")
	}

	var paciente = Paciente{Nome: args[1], Sala: args[2], Medico: args[3], Especialidade: args[4], Exame: args[5]}

	pacienteAsBytes, _ := json.Marshal(paciente)
	APIstub.PutState(args[0], pacienteAsBytes)
...
func (s *SmartContract) changePacienteMedico(APIstub shim.ChaincodeStubInterface, args []string) sc.Response {

	if len(args) != 2 {
		return shim.Error("Incorrect number of arguments. Expecting 2")
	}

	pacienteAsBytes, _ := APIstub.GetState(args[0])
	paciente := Paciente{}

	json.Unmarshal(pacienteAsBytes, &paciente)
	paciente.Medico = args[1]
