...
func (s *SmartContract) retrieve(APIstub shim.ChaincodeStubInterface, args []string ) sc.Response {
	...
	for i = 0; iterator.HasNext(); i++ {
		...
		// err = json.Unmarshal(	[]byte(json_string), &unitJSON)
		...
		// total_result=total_result+"\\\"Object"+strconv.Itoa(i)+"\\\":{\\\"key\\\":\\\""+args[0]+"\\\",\\\"time\\\":\\\""+returnedTimestamp+"\\\",\\\"workExp\\\":\\\""+unitJSON.WorkExp+"\\\"}"

		total_result=total_result+"\\\"Object"+strconv.Itoa(i)+"\\\":{\\\"key\\\":\\\""+args[0]+"\\\",\\\"time\\\":\\\""+returnedTimestamp+"\\\",\\\"workExp\\\":\\\""+unitJSON.WorkExp+"\\\",\\\"eduExp\\\":\\\""+unitJSON.EduExp+"\\\",\\\"contact\\\":\\\""+unitJSON.Contact+"\\\"}"
