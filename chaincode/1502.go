...
func (cc *LicenseChaincode) create(stub shim.ChaincodeStubInterface, arg []string) peer.Response {
    ...
    data := License{ Id: args[0], Participant_id: args[1], CreatedOn: dateValue2, CreatedBy: args[3], IsDelete: boolValue4, LicenseId: args[5], LicenseKey: args[6], OrganisationName: args[7], Notes: args[8] }
...
func (cc *LicenseChaincode) get(stub shim.ChaincodeStubInterface, args []string) peer.Response {
...
func (cc *LicenseChaincode) update(stub shim.ChaincodeStubInterface, arg []string) peer.Response {
...
func (cc *LicenseChaincode) delete(stub shim.ChaincodeStubInterface, args []string) peer.Response {
...
func (cc *LicenseChaincode) history(stub shim.ChaincodeStubInterface, args []string) peer.Response {
...
func (cc *LicenseChaincode) querystring(stub shim.ChaincodeStubInterface, args []string) peer.Response {
...
func (cc *LicenseChaincode) Init(stub shim.ChaincodeStubInterface) peer.Response {
	return shim.Success(nil)
}

func (cc *LicenseChaincode) Invoke(stub shim.ChaincodeStubInterface) peer.Response {
...
func main() {
	...
	err := shim.Start(new(LicenseChaincode))
	if err != nil {
